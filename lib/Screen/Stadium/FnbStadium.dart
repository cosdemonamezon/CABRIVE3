...
class FnbStadium extends StatefulWidget {
  FnbStadium({Key key}) : super(key: key);

  @override
  _FnbStadiumState createState() => _FnbStadiumState();
}

class _FnbStadiumState extends State<FnbStadium> {
  @override
        ...
        leading: IconButton(
            ...
            onPressed: () {
              Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(builder: (context) => Detailmath()),
                  (route) => false);
            }),
        centerTitle: true,
