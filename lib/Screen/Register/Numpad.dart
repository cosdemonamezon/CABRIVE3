...
class NumpadButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget label = icon != null ? Icon(icon, color: kLinkTextColor.withOpacity(0.8), size: 35.0,)
    ...
    return Container(
      ...
      child: OutlineButton(
        ...
        highlightedBorderColor: icon!=null ? kLinkTextColor : Theme.of(context).primaryColor.withOpacity(0.3),
        splashColor: icon!=null ? kLinkTextColor : Theme.of(context).primaryColor.withOpacity(0.1),
